...
namespace udit
{
    ...
    const string Scene::vertex_shader_code =
        ...
        "   texture_uv  = vertex_texture_uv * 2.0 - 1.0;"
        "}";
    ...
    const string Scene::fragment_shader_code =
        ...
        ""
        "void main()"                // Círculo centrado en el origen: x * x + y * y < r * r, siendo r = 1
        "{"
        "    fragment_color = texture_uv.s * texture_uv.s + texture_uv.t * texture_uv.t < 1.0 ? vec4(1.0) : vec4(0.0, 0.0, 1.0, 1.0);"
        "}";
